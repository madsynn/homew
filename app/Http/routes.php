...
//
//$router->get('{CategoryProduct}', function(App\Models\CategoryProduct $categoryproduct) {
//    //
//});
...
Route::group(['prefix' => LaravelLocalization::getCurrentLocale(), 'before' => ['localization', 'before']], function () {
    ...
    // photo gallery
    Route::get('/photo-gallery/{slug}', ['as' => 'dashboard.photo_gallery.show', 'uses' => 'PhotoGalleryController@show']);
...
Route::group(['prefix' => LaravelLocalization::getCurrentLocale()], function () {
    ...
    Route::group([
	    ...
	    //Route::post('product/{id}/toggle-publish', ['as' => 'admin.product.toggle-publish', 'uses' => 'ProductController@togglePublish'])->where('id', '[0-9]+');
